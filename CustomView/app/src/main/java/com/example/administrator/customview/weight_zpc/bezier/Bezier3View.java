...
public class Bezier3View extends View{
    ...
    private Point assistPoint2;//控制点
    ...
    private void init(){
        ...
        assistPoint2 = new Point(250, 100);
...
//        path.quadTo(assistPoint.x,assistPoint.y,endtPoint.x,endtPoint.y);
        path.cubicTo(assistPoint2.x,assistPoint2.y,assistPoint.x,assistPoint.y,endtPoint.x,endtPoint.y);
        //画path
        ...
        canvas.drawLine(assistPoint.x,assistPoint.y,assistPoint2.x,assistPoint2.y,paint);
